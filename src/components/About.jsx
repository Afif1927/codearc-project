    ...
    <div className='w-full p-20 bg-[#CDEA68] rounded-tl-3xl  rounded-tr-3xl text-black'>
        ...
        <div className="w-full flex gap-5 pt-10 border-t-[1px] mt-20 border-[#c1dc60]  ">
          <div className="w-1/2 ">
            ...
            <button className=' flex gap-10 items-center px-10 mt-10 py-6 bg-zinc-900 rounded-full text-white uppercase'>Read More
              <div className="w-2 h-2 rounded-full bg-zinc-100" ></div>
            </button>
          </div>
          <div className="w-1/2 h-[65vh] bg-[#889653] rounded-3xl"></div>
        </div>
    </div>
  )
}
