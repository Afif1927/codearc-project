...
function LandingPage() {
 ...
 <div className='w-full h-screen bg-zinc-900 pt-1'>
    ...
    <div className="masker overflow-hidden" >
      <div className="w-fit flex items-center ">
        {index === 1 && (<div className='  w-[8.5vw] h-[5.9vw]  relative -top-[0.4vw] rounded-md bg-green-500'> </div>) }
 ...
 <div className="border-t-[1px] border-zinc-800 mt-20 flex justify-between items-center py-5 px-20 ">
    ...
    <div className="start flex items-center gap-5">
         <div className='px-5 py-2 border-[2px] border-zinc-500       rounded-full font-light text-md uppercase'>Start the project
          </div>  
